...
\begin{abstract}
A novel coronavirus (SARS-CoV-2) first detected in Wuhan, China, has spread rapidly since December 2019, causing over 45,000 confirmed infections and more than 1,000 fatalities (as of Feb 12, 2020). Imported cases and small transmission clusters have been reported globally.
Early data suggests the virus transmits readily and a pandemic cannot be ruled out.
Based data from routine diagnostics showing a strong and consistent seasonal variation of the four endemic coronaviruses (229E, HKU1, NL63, OC43), we explore the effect of seasonal variation in transmissibility on a potential SARS-CoV-2 pandemic. 
...
%\Jan{https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200212-sitrep-23-ncov.pdf added. Nice map.}
